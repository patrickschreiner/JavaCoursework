////Rout3 is another router on the network with its own unique costs
...
public class Rout3{
	public static void main(String[] args){
		...
		int[] RoutTable = {7, 16, 2, 0};
		int[] SourceTable;
		int LocalRout = 3;
		int RecvRout;
		try{
			//Create connection with Source Router
			ServSocket = new ServerSocket(12347);
			...
			while(true){
				...
				//Stream to send Rout3 routing table to Rout0
				...
				int distance3to0 = RoutTable[0];
				int distance3to1 = RoutTable[1];
				int distance3to2 = RoutTable[2];
				int distance3to3 = RoutTable[3];
				BufferedTextOut.write(String.valueOf(LocalRout) + "\n");
				BufferedTextOut.write(String.valueOf(distance3to0) + "\n");
				BufferedTextOut.write(String.valueOf(distance3to1) + "\n");
				BufferedTextOut.write(String.valueOf(distance3to2) + "\n");
				BufferedTextOut.write(String.valueOf(distance3to3) + "\n");
